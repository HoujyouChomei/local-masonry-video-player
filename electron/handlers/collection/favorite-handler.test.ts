// electron/handlers/collection/favorite-handler.test.ts

import { describe, it, expect, vi, beforeEach } from 'vitest';
import { IpcMainInvokeEvent } from 'electron';
import { handleFavorites } from './favorite-handler';
...
// パス修正 & クラス名変更: ../core/repositories/video-repository -> ../../core/repositories/media/media-repository
...
vi.mock('../../core/services/file/file-integrity-service', () => ({
